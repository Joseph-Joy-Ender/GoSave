...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public TransactionHistoryResponse getTransactionHistory(Long id) throws UserException, UserNotFoundException {
    ...
    @Override
    public ApiResponse<?> transferMoneyToWallet(SaveRequest saveRequest) throws UserNotFoundException {
        RestTemplate restTemplate = new RestTemplate();
        ModelMapper mapper = new ModelMapper();
        Wallet mappedWallet = mapper.map(saveRequest,Wallet.class);
        Optional<User> foundUser = userRepository.findById(mappedWallet.getId());
